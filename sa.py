...
"[FBAN/FBIOS;FBAV/503.0.0.56.104;FBBV/268662775;FBDV/iPhone8,2;FBMD/iPhone;FBSN/iOS;FBSV/16.6.1;FBSS/3;FBID/phone;FBLC/pt_PT;FBOP/5;FBRV/",
...
"""
        ...
        bad += 1
        sys.stdout.write(اعادة + f'\r{ppp}BAD ACCOUNT | Bad {bad} | CP {CP} | Hit {hit} | {اعادة}{ازرق} @salhpy')
        sys.stdout.flush()
tele()
choose_country()
def tt():
